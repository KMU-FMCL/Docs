...
> [!Tip] Query Parameter
>
> > [!example] Return Custom Query Parameter
> >
> > ```python
...
> > ```
>
> - Endpoint Function 는 `greet(Custom)` 로 정의 <p style='margin-top: 0.25em; margin-bottom: 0.25em'></p>
> - `@app.get("/hi/{Custom}")` 이 존재 X <p style='margin-top: 0.125em; margin-bottom: 0.125em'></p>
...
> > > ```
>
> - 다른 방식으로 String 을 제공하고, &nbsp;이를 [[FastAPI-HTTP-Request#FastAPI 의 HTTP Request 해석|Path]] 로 전달해 Final Response 로 보냄
